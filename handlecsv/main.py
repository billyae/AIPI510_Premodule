...
@click.option('--rowindex',default=-1,help='This is the index of row to be deleted in the csvfile')
@click.option('--columnname',default="-1",help='This is the name of column to be deleted in the csvfile')
@click.option('--countrow',default=False,help='This is whether you want to count the number of rows in the csvfile after delete')
@click.option('--countcolumn',default=False,help='This is whether you want to count the number of columns in the csvfile after delete')
